...
namespace WumpusTest
{
    ...
    public class Game1 : Microsoft.Xna.Framework.Game
    {
        ...
        Sprite SettingsButton, BG, Arrows, Move, Skip, Story, HighScoresBG;
        ...
        */
        ...
        private void UpdateButtonIgnitesMenu()
        {
            Color ButtonIgniteColor = Color.Aquamarine;
            Vector2 CursorOr = CursorRight.Position + new Vector2(CursorRight.height / 2);
            if (MyMenu.MyMenuState == Menu.MenuState.Startup)
            {
                MyMenu.PlayButton.myColor = (MyMenu.PlayButton.isOver(CursorOr) ? ButtonIgniteColor : Color.White);
                MyMenu.OptionsButton.myColor = (MyMenu.OptionsButton.isOver(CursorOr) ? ButtonIgniteColor : Color.White);
                MyMenu.ExitGameButton.myColor = (MyMenu.ExitGameButton.isOver(CursorOr) ? ButtonIgniteColor : Color.White);
                MyMenu.HighScoresButton.myColor = (MyMenu.HighScoresButton.isOver(CursorOr) ? ButtonIgniteColor : Color.White);
            }
            else if (MyMenu.MyMenuState == Menu.MenuState.Options)
            {
                MyMenu.MusicOn.myColor = (MyMenu.MusicOn.isOver(CursorOr) ? ButtonIgniteColor : Color.White);
                MyMenu.MusicOff.myColor = (MyMenu.MusicOff.isOver(CursorOr) ? ButtonIgniteColor : Color.White);
                MyMenu.SoundOn.myColor = (MyMenu.SoundOn.isOver(CursorOr) ? ButtonIgniteColor : Color.White);
                MyMenu.SoundOff.myColor = (MyMenu.SoundOff.isOver(CursorOr) ? ButtonIgniteColor : Color.White);
                MyMenu.Cheats.myColor = (MyMenu.Cheats.isOver(CursorOr) ? ButtonIgniteColor : Color.White);
                MyMenu.Debug.myColor = (MyMenu.Debug.isOver(CursorOr) ? ButtonIgniteColor : Color.White);
                MyMenu.Mouse.myColor = (MyMenu.Mouse.isOver(CursorOr) ? ButtonIgniteColor : Color.White);
                MyMenu.Keyboard.myColor = (MyMenu.Keyboard.isOver(CursorOr) ? ButtonIgniteColor : Color.White);
                MyMenu.Kinect.myColor = (MyMenu.Kinect.isOver(CursorOr) ? ButtonIgniteColor : Color.White);
                MyMenu.Back.myColor = (MyMenu.Back.isOver(CursorOr) ? ButtonIgniteColor : Color.White);
            }
        }
        ...
        private void UpdateMouseClicks(MouseState OldState)
        {
            ...
            if (NewState.LeftButton == ButtonState.Pressed && OldState.LeftButton == ButtonState.Released)
            {
                    ...
                    if (MyGameControl.PlayerMode == GameControl.PlayerState.Trivia)
                    {
                        ...
                        for (int i = 0; i < MyGameControl.MyTrivia.AnswerButtons.Length; i++)
                        {
                            ...
                            if (s.isOver(MousePos))
                            {
                                ...
                                else if (MyGameControl.questionN >= nOfQuestionsFor('w') && wump)
                                {
                                    EndTrivia(wump);
                                }
                                else if (MyGameControl.questionN >= nOfQuestionsFor('p') && !wump)
                                {
                                    EndTrivia(wump);
                                }
                                else
                ...
                {
                    if (Skip.isOver(CursorRight.Position + new Vector2(CursorRight.height/2)) || Skip.isOver(CursorLeft.Position + new Vector2(CursorLeft.height/2)))
                    {
        ...
        private void EndTrivia(bool wump)
        {
            ...
            MyGameControl.questionN = 1;
            MyGameControl.questionsAnsweredCorrectly = 0;
        }
        ...
        /// End game sequence.
        /// </summary>
        /// <param name="reason">The reason for dying: 0 = trivia, 1 = arrows </param>
        private void EndGame(int reason)
        {
            ...
            {
                case 0:
                    loss = "Sorry, you didn't get enough\ntrivia questions right...";
                    break;
                case 1:
                    loss = "Sorry, you ran out of arrows.";
                    break;
            }
            MyGameControl.MyPlayer.setScore(MyGameControl.MyPlayer.getScore() + ((MyGameControl.won) ? 100 : 0));
        ...
        protected override void Draw(GameTime gameTime)
        {
            ...
            if (MyControls != Controls.Kinect)
            {
                CursorLeft.Position = new Vector2(-80, -80);
            }
            ...
            {
                HighScoresBG.Draw(spriteBatch, this.Content);
            ...
            else if (MyGameControl.GameState == GameControl.Gstate.PreGame)
            {
                ...
                if (StoryWatch.Elapsed.TotalMilliseconds > 5000)
                {
                    storyIndex++;
                    StoryWatch.Restart();
                }
        ...
        private void DrawText()
        {
            if (MyGameControl.isDebugMode)
            {
                ...
                Debug += "\nPit1: " + new Room(MyGameControl.MyMap.getAllPitRooms()[1]);
            ...
            else if (MyGameControl.GameState == GameControl.Gstate.EndGame)
            {
                ...
                spriteBatch.DrawString(HUDFont, "Your score:\n" + MyGameControl.MyPlayer.getScore(), new Vector2(170, 40), Color.White);
                string highs = "";
                ...
                str += highs;
                spriteBatch.DrawString(HUDFont, str, new Vector2(170, 100), Color.White);
