...
namespace WumpusTest
{
    ...
    public class Game1 : Microsoft.Xna.Framework.Game
    {
        ...
        Sprite SettingsButton, BG, Arrows, Move, Buy;
        ...
        Stopwatch MyWatch = new Stopwatch(), KinectWatch = new Stopwatch(), TempWatch = new Stopwatch();
        ...
        protected override void Initialize()
        {
            ...
            Move = new Sprite(new Vector2(0, 460 - 100), "Arrows\\MoveButton");
            Buy = new Sprite(new Vector2(0, 360 - 150), "Buy");
        ...
        */
        ...
        private void ShowTriviaHint()
        {
            MyGameControl.MyTrivia.safeRandomizeIndex();
            string randomQ = MyGameControl.MyTrivia.getQuestion();
        }
