...
namespace WumpusTest
{
    class GameControl
    {
        ...
        {
            return (MyPlayer.Position.X + x) > Room.RoomSize.Left + (CenteredSprite.height / 2) && MyPlayer.Position.X + x < Room.RoomSize.Right - (CenteredSprite.height / 2) &&
                    (MyPlayer.Position.Y + y) > Room.RoomSize.Top + (CenteredSprite.height / 2) && MyPlayer.Position.Y + y < Room.RoomSize.Bottom - (CenteredSprite.height / 2);
        }
